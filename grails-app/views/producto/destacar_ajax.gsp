...
%{--    </div>--}%
    ...
    <div class="col-md-6" style="font-size: 15px">
       <i class="fa fa-magic fa-2x text-warning"></i> Con una <strong>pequeña inversión</strong>, destaque su anuncio para que aparezca en la parte superior de
        Anuncios, o que se halle <span class="titulo0">siempre visible</span> en el carrusel de imágenes en la pantalla principal.
    </div>
