...
<head>
    ...
    <title>Producto: ${producto?.titulo}</title>
                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            ...
                            <li><a href=""><i class="fa fa-envelope"></i> tedein@domain.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            <li><a href="${createLink(controller: 'principal', action: 'index')}" class="active">Principal</a></li>
                ...
                <div class="category-tab shop-details-tab"><!--category-tab-->
                    <div class="col-sm-12">
                        <ul class="nav nav-tabs">
                            <li><a href="#details" data-toggle="tab">Información</a></li>
                            <li><a href="#companyprofile" data-toggle="tab">Características</a></li>
%{--                            <li><a href="#tag" data-toggle="tab">Tag</a></li>--}%
                            <li class="active"><a href="#reviews" data-toggle="tab">Contacte al vendedor</a></li>
                        </ul>
                    </div>
